...
class BitmexClient:
    def __init__(self, public_key: str, secret_key: str, testnet: bool):
        ...
        self._headers = {'api-key': self._public_key,
                         'api-signature': self._generate_signature,
                         'api-expires': self._generate_expires}
    ...
    def place_order(self, contract: Contract, order_type: str, quantity: int, side: str, price=None, tif=None) -> OrderStatus:
        ...
        data['side'] = order_type.capitalize()
    ...
    def get_historical_candles(self, contract: Contract, interval: str) -> typing.List[Candle]:
        ...
        if raw_candles is not None:
            for c in reversed(raw_candles):
                candles.append(Candle(c, interval, "bitmex"))
    ...
    def _generate_expires(self):
        return int(time.time() + self._TIMEOUT)
